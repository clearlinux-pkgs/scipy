...
%prep
%setup -q -n scipy-1.8.0
cd %{_builddir}/scipy-1.8.0
...
cp %{_builddir}/scipy-1.8.0/doc/source/_static/scipy-mathjax/LICENSE %{buildroot}/usr/share/package-licenses/scipy/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/scipy-1.8.0/doc/sphinxext/LICENSE.txt %{buildroot}/usr/share/package-licenses/scipy/df4f727b25238b8a4be050714fe3f1cb06b17f75
cp %{_builddir}/scipy-1.8.0/doc/sphinxext/doc/scipy-sphinx-theme/LICENSE.txt %{buildroot}/usr/share/package-licenses/scipy/fd2e79f66abba5b94347c2df9ca6cf3584b0c517
cp %{_builddir}/scipy-1.8.0/scipy/_lib/_uarray/LICENSE %{buildroot}/usr/share/package-licenses/scipy/589977b80bebdf03e98a6f333b7e0e7a5fd804b8
cp %{_builddir}/scipy-1.8.0/scipy/_lib/boost/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/scipy/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/scipy-1.8.0/scipy/fft/_pocketfft/LICENSE.md %{buildroot}/usr/share/package-licenses/scipy/612568676ab43b80b877fce96fa4a917137117ff
cp %{_builddir}/scipy-1.8.0/scipy/linalg/src/lapack_deprecations/LICENSE %{buildroot}/usr/share/package-licenses/scipy/f9ccbd191ba31d3f0d69b364758122fc908b546d
cp %{_builddir}/scipy-1.8.0/scipy/ndimage/LICENSE.txt %{buildroot}/usr/share/package-licenses/scipy/58744c28e64b1d647917e9a8490b869221629c72
cp %{_builddir}/scipy-1.8.0/scipy/optimize/_highs/LICENSE %{buildroot}/usr/share/package-licenses/scipy/0fb301a89b68fac0ca71fdfbc2522b7b63576dad
cp %{_builddir}/scipy-1.8.0/scipy/optimize/_highs/external/LICENCE_1_0.txt %{buildroot}/usr/share/package-licenses/scipy/3f317fbb3e08fd99169d2e77105d562ea0e482c7
cp %{_builddir}/scipy-1.8.0/scipy/optimize/_highs/external/filereaderlp/LICENSE %{buildroot}/usr/share/package-licenses/scipy/ee3e4ebdf82451452fe0c5c9466d90d76dec773f

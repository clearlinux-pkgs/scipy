...
Source0  : https://github.com/scipy/scipy/releases/download/v1.13.0/scipy-1.13.0.tar.gz
...
%prep
%setup -q -n scipy-1.13.0
cd %{_builddir}/scipy-1.13.0
pushd ..
cp -a scipy-1.13.0 buildavx2
popd
pushd ..
cp -a scipy-1.13.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712164804
...
cp %{_builddir}/scipy-%{version}/LICENSES_bundled.txt %{buildroot}/usr/share/package-licenses/scipy/792513fc23d86fb66e21989359196014fbbeb65f || :
...
/usr/share/package-licenses/scipy/792513fc23d86fb66e21989359196014fbbeb65f

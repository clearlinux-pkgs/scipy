...
Source0  : https://github.com/scipy/scipy/releases/download/v1.12.0/scipy-1.12.0.tar.gz
...
%prep
%setup -q -n scipy-1.12.0
cd %{_builddir}/scipy-1.12.0
pushd ..
cp -a scipy-1.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705967920

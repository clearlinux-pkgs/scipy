...
Version  : 1.11.4
Release  : 174
URL      : https://github.com/scipy/scipy/releases/download/v1.11.4/scipy-1.11.4.tar.gz
Source0  : https://github.com/scipy/scipy/releases/download/v1.11.4/scipy-1.11.4.tar.gz
...
%prep
%setup -q -n scipy-1.11.4
cd %{_builddir}/scipy-1.11.4
pushd ..
cp -a scipy-1.11.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700497684

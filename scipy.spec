...
Version  : 1.5.1
Release  : 118
URL      : https://github.com/scipy/scipy/releases/download/v1.5.1/scipy-1.5.1.tar.xz
Source0  : https://github.com/scipy/scipy/releases/download/v1.5.1/scipy-1.5.1.tar.xz
...
%prep
%setup -q -n scipy-1.5.1
cd %{_builddir}/scipy-1.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594255266
...
cp %{_builddir}/scipy-1.5.1/doc/scipy-sphinx-theme/LICENSE.txt %{buildroot}/usr/share/package-licenses/scipy/fd2e79f66abba5b94347c2df9ca6cf3584b0c517
cp %{_builddir}/scipy-1.5.1/doc/source/_static/scipy-mathjax/LICENSE %{buildroot}/usr/share/package-licenses/scipy/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/scipy-1.5.1/doc/sphinxext/LICENSE.txt %{buildroot}/usr/share/package-licenses/scipy/df4f727b25238b8a4be050714fe3f1cb06b17f75
cp %{_builddir}/scipy-1.5.1/scipy/_lib/_uarray/LICENSE %{buildroot}/usr/share/package-licenses/scipy/589977b80bebdf03e98a6f333b7e0e7a5fd804b8
cp %{_builddir}/scipy-1.5.1/scipy/fft/_pocketfft/LICENSE.md %{buildroot}/usr/share/package-licenses/scipy/612568676ab43b80b877fce96fa4a917137117ff
cp %{_builddir}/scipy-1.5.1/scipy/linalg/src/lapack_deprecations/LICENSE %{buildroot}/usr/share/package-licenses/scipy/f9ccbd191ba31d3f0d69b364758122fc908b546d
cp %{_builddir}/scipy-1.5.1/scipy/ndimage/LICENSE.txt %{buildroot}/usr/share/package-licenses/scipy/58744c28e64b1d647917e9a8490b869221629c72
cp %{_builddir}/scipy-1.5.1/scipy/optimize/tnc/LICENSE %{buildroot}/usr/share/package-licenses/scipy/41248a200801dfbc906b81e9a00c811474b64062
cp %{_builddir}/scipy-1.5.1/scipy/sparse/linalg/dsolve/SuperLU/License.txt %{buildroot}/usr/share/package-licenses/scipy/1088e18e7415cdcdfc4b3647a33837cc272b6532
cp %{_builddir}/scipy-1.5.1/scipy/sparse/linalg/eigen/arpack/ARPACK/COPYING %{buildroot}/usr/share/package-licenses/scipy/a8322a2036b23080e6706a894c314b9f477dce58
cp %{_builddir}/scipy-1.5.1/scipy/spatial/qhull_src/COPYING.txt %{buildroot}/usr/share/package-licenses/scipy/5a74d9542429d0f078329ddbd01eb32bf26a88f3

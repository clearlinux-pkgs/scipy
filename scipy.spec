...
Source0  : https://github.com/scipy/scipy/releases/download/v1.13.1/scipy-1.13.1.tar.gz
...
%prep
%setup -q -n scipy-1.13.1
cd %{_builddir}/scipy-1.13.1
pushd ..
cp -a scipy-1.13.1 buildavx2
popd
pushd ..
cp -a scipy-1.13.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716764345

...
Version  : 1.15.3
Release  : 188
URL      : https://github.com/scipy/scipy/releases/download/v1.15.3/scipy-1.15.3.tar.gz
Source0  : https://github.com/scipy/scipy/releases/download/v1.15.3/scipy-1.15.3.tar.gz
...
%prep
%setup -q -n scipy-1.15.3
cd %{_builddir}/scipy-1.15.3
pushd ..
cp -a scipy-1.15.3 buildavx2
popd
pushd ..
cp -a scipy-1.15.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746728799
